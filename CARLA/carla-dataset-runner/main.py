...
if __name__ == "__main__":
    ...
    parser.add_argument('csv_file', default=None, type=str, help='name of csv file to save the data')
    parser.add_argument('-wi', '--width', default=512, type=int, help="camera rgb and depth sensor width in pixels")
    parser.add_argument('-he', '--height', default=384, type=int, help="camera rgb and depth sensor width in pixels")
    parser.add_argument('-ve', '--vehicles', default=70, type=int, help="number of vehicles to spawn in the simulation")
    ...
    CarlaWorld = CarlaWorld(csv_file=args.csv_file)

    timestamps = []
    egos_to_run = 50
    print('Starting to record data...')
    with open(args.csv_file, "w+") as f: 
        f.write(",".join(["img_path", "timestamp", "steer_angle_degrees"])+"\n")
    ...
    for weather_option in CarlaWorld.weather_options:
        ...
        while ego_vehicle_iteration < egos_to_run:
            ...
            CarlaWorld.num_seqs_recorded += 1
